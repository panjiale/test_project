...
(
	...
	'login_rename' => '您登录的用户名 \"$username\" 已经被他人使用，请更换其他名字后再登录。',
	'login_rename_invalid' => '用户名无效，密码错误或安全问题回答错误，您可以有至多 5 次尝试，请返回修改。',
	'login_rename_succeed' => '\"$username\" 已成功更名为 \"$usernamenew\"，请用新用户名的登录。',
	...
	'forum_access_disallow' => '对不起，您在本版没有权利进行此操作，请返回',
	'forum_access_view_disallow' => '对不起，您在本版没有权利进行此操作，请返回',
	...
	'register_invite_iperror' => '注册用户 IP 和邀请码拥有者 IP 相同，不能注册请返回。',
	...
	'register_activation' => '对不起，您输入的用户名 \"$username\" 已经存在，请<a href=\"logging.php?action=login\">登录论坛</a>激活此帐号。',
	...
	'modcp_ann_nofound' => '该公告已经删除或您没有权利编辑它，请返回',
	'modcp_logout_successed' => '成功退出管理面板，返回论坛',
	'members_edit_succeed' => '用户信息成功更新，请继续操作',
	'modcp_member_ban_successed' => '用户资料成功更新',
	'admin_cpanel_noaccess' => '您没有权利访问管理面板，请重新登录论坛，然后重试',
