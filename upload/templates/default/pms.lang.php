...
[b]以下您所发表的帖子被 [url={$boardurl}space.php?uid={$discuz_uid}][i]{$discuz_user}[/i][/url] 执行 {$modaction} 操作。[/b]
[quote]{$post[message]}[/quote]
...
[b]以下您所发表的帖子被 [url={$boardurl}space.php?uid={$discuz_uid}][i]{$discuz_user}[/i][/url] 执行 {$modaction} 操作。[/b]
[quote]{$post[message]}[/quote]
累计 $warninglimit 次警告，您将被自动禁止发帖 $warningexpiration 天。
...
详情请[url={$boardurl}memcp.php?action=creditslog]点击这里[/url]访问您的积分转账与兑换记录。',
	...
	'reportpost_subject'	=> '$discuz_user 向您报告一篇帖子',
...
与您交易的 $discuz_user 已经给您作了评价，请尽快评价对方。',
	...
	'buddy_new_subject' => '{$discuz_user} 添加您为好友',
