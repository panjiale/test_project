...
/*
	...
	$Id: moderation.inc.php 12944 2008-03-18 10:11:39Z monkey $
*/
...
if(!in_array($operation, array('delete', 'move', 'copy', 'highlight', 'type', 'close', 'stick', 'digest', 'removereward', 'bump', 'recommend')) || (!$allowdelpost && $operation == 'delete') || (!$allowstickthread && $operation == 'stick')) {
...
if(!submitcheck('modsubmit')) {
	...
	if(in_array($operation, array('stick', 'digest', 'highlight', 'close', 'recommend'))) {
