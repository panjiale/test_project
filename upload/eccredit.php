...
/*
	...
	$Id: eccredit.php 13420 2008-04-14 10:20:32Z heyond $
*/
...
if(empty($action)) {
	...
	$member['avatar'] = '<div class="avatar"><img src="'.discuz_uc_avatar($member['uid']).'" />';
	if($_DCACHE['usergroups'][$member['groupid']]['groupavatar']) {
		$post['avatar'] .= '<br /><img src="'.$_DCACHE['usergroups'][$member['groupid']]['groupavatar'].'" border="0" alt="" />';
	}
	$member['avatar'] .= '</div>';
