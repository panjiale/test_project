...
/*
	...
	$Id: insenz.inc.php 13486 2008-04-18 04:32:01Z liuqiang $
*/
...
<?php
	...
	if(submitcheck('pushsubmit')) {
		...
		cpmsg('insenz_campaign_pushed', 'admincp.php?action=insenz', 'succeed');
		...
		echo '<script type="text/JavaScript">
			...
			cpmsg('insenz_campaign_specified_ignored', 'admincp.php?action=insenz', 'succeed');
		...
		echo '<script type="text/JavaScript">
			...
			cpmsg('insenz_campaign_specified_deleted', 'admincp.php?action=insenz', 'succeed');
	...
	if(submitcheck('acceptsubmit')) {
		...
		cpmsg('insenz_vf_send', 'admincp.php?action=insenz&amp;operation=virtualforum&amp;c_status=2', 'succeed');
